...
from PySide6.QtWidgets import (
    QFrame, QHBoxLayout, QVBoxLayout, QApplication, QWidget
)
from qfluentwidgets import (
    NavigationItemPosition, MessageBox, setTheme, Theme, MSFluentWindow,
    NavigationAvatarWidget, qrouter, SubtitleLabel, setFont, Icon,
    GroupHeaderCardWidget, PushButton, ComboBox, LineEdit, IconWidget,
...
class MainWindow(MSFluentWindow):
    ...
    def _buildPageForWidget(self, widget: QWidget, name: str):
