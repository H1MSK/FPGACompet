...
module AxiStreamWidthAdaptorI8O32 (
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in TDATA" *) input  wire [63:0]   i_payload_data,
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 in TKEEP" *) input  wire [7:0]    i_payload_keep,
  ...
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 out TDATA" *) output wire [255:0]  o_payload_data,
  (* X_INTERFACE_INFO = "xilinx.com:interface:axis:1.0 out TKEEP" *) output wire [31:0]   o_payload_keep,
  ...
  wire       [255:0]  axi4StreamWidthAdapter_1_io_axis_m_payload_data;
  wire       [31:0]   axi4StreamWidthAdapter_1_io_axis_m_payload_keep;
  ...
  Axi4StreamWidthAdapter axi4StreamWidthAdapter_1 (
    ...
    .io_axis_s_payload_data (i_payload_data[63:0]                                  ), //i
    .io_axis_s_payload_keep (i_payload_keep[7:0]                                   ), //i
    ...
    .io_axis_m_payload_data (axi4StreamWidthAdapter_1_io_axis_m_payload_data[255:0]), //o
    .io_axis_m_payload_keep (axi4StreamWidthAdapter_1_io_axis_m_payload_keep[31:0] ), //o
